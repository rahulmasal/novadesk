...
import { Database, Download, ShieldCheck, History, AlertTriangle, Upload } from "lucide-react";
          ...
          <div className="glass-dark rounded-2xl p-8 border border-purple-500/10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-400">Upload a backup file to restore system state</p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="border-2 border-dashed border-white/10 group-hover:border-purple-500/30 rounded-xl p-8 text-center transition-all">
                ...
                <p className="text-white font-medium">
                  {isRestoring ? "Restoring System..." : "Click or drag backup file here"}
                </p>
